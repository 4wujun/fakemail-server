...
<link rel="stylesheet" type="text/css" href="<c:url value="/webjars/datatables/css/dataTables.bootstrap.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/webjars/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/css/fakemail.css"/>">
...
<script type="text/javascript" src="<c:url value="/webjars/datatables/js/jquery.dataTables.js"/>"></script>
<script type="text/javascript" src="<c:url value="/webjars/datatables/js/dataTables.bootstrap.js"/>"></script>
...
<script type="text/javascript" src="<c:url value="/js/fakemail.js"/>"></script>
